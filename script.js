...
// COUNTDOWN KE 2
const targetDate2 = new Date("May 25, 2026 09:00:00").getTime();
...
const countdownInterval2 = setInterval(() => {
    ...
    if (distance < 0) {
        ...
        document.getElementById("hari2").innerText = "00";
        document.getElementById("jam2").innerText = "00";
        document.getElementById("menit2").innerText = "00";
        document.getElementById("detik2").innerText = "00";

        return;
    }

    document.getElementById("hari2").innerText =
        Math.floor(distance / (1000 * 60 * 60 * 24))
        .toString()
        .padStart(2, '0');

    document.getElementById("jam2").innerText =
        Math.floor((distance % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60))
        .toString()
        .padStart(2, '0');

    document.getElementById("menit2").innerText =
        Math.floor((distance % (1000 * 60 * 60)) / (1000 * 60))
        .toString()
        .padStart(2, '0');

    document.getElementById("detik2").innerText =
